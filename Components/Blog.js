...
function Blog({ title, id, description, index, timestamp }) {
  ...
  return (
    <>
      <Fade top>
      <div onClick={() => {router.push(`blogs/${id}`)}}  className=" cursor-pointer transition-all duration-200 hover:bg-gray-900/40 flex flex-col justify-center  border border-gray-900 bg-gray-900/20  p-3 px-5  space-y-2 rounded-md shadow-2xl h-auto">
